...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-CcL68W6J.js')),
			__memo(() => import('./chunks/1-BYuLJoOJ.js')),
			__memo(() => import('./chunks/2-0mgXIGLP.js')),
			__memo(() => import('./chunks/3-Dc5FKRa9.js')),
			__memo(() => import('./chunks/4-B79RcJFi.js')),
			__memo(() => import('./chunks/5-BnqR2_cH.js')),
			__memo(() => import('./chunks/6-Bwii1gG6.js')),
			__memo(() => import('./chunks/7-PukifZUz.js')),
			__memo(() => import('./chunks/8-CYG6ozbZ.js'))
		],
		routes: [
			{
				id: "/",
